 ...
 *  Compilation:  javac com.cfy.learn.algorithm.util.stdlib.StdIn.java
 *  Execution:    java com.cfy.learn.algorithm.util.stdlib.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code com.cfy.learn.algorithm.util.stdlib.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code com.cfy.learn.algorithm.util.stdlib.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">com.cfy.learn.algorithm.util.stdlib.StdIn.java</a>
 ...
 *  <pre>
 *  while (!com.cfy.learn.algorithm.util.stdlib.StdIn.isEmpty()) {
 *      double value = com.cfy.learn.algorithm.util.stdlib.StdIn.readDouble();
 *      com.cfy.learn.algorithm.util.stdlib.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (com.cfy.learn.algorithm.util.stdlib.StdIn.hasNextChar()) {
 *      char c = com.cfy.learn.algorithm.util.stdlib.StdIn.readChar();
 *      com.cfy.learn.algorithm.util.stdlib.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (com.cfy.learn.algorithm.util.stdlib.StdIn.hasNextLine()) {
 *      String line = com.cfy.learn.algorithm.util.stdlib.StdIn.readLine();
 *      com.cfy.learn.algorithm.util.stdlib.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = com.cfy.learn.algorithm.util.stdlib.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code com.cfy.learn.algorithm.util.stdlib.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code com.cfy.learn.algorithm.util.stdlib.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code com.cfy.learn.algorithm.util.stdlib.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code com.cfy.learn.algorithm.util.stdlib.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code com.cfy.learn.algorithm.util.stdlib.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code com.cfy.learn.algorithm.util.stdlib.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code com.cfy.learn.algorithm.util.stdlib.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code com.cfy.learn.algorithm.util.stdlib.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code com.cfy.learn.algorithm.util.stdlib.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to com.cfy.learn.algorithm.util.stdlib.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to com.cfy.learn.algorithm.util.stdlib.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to com.cfy.learn.algorithm.util.stdlib.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to com.cfy.learn.algorithm.util.stdlib.StdIn
    
    
    // do this once when com.cfy.learn.algorithm.util.stdlib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If com.cfy.learn.algorithm.util.stdlib.StdIn changes, use this to reinitialize the scanner.
     */
