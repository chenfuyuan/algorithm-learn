 ...
 *  Compilation:  javac com.cfy.learn.algorithm.util.stdlib.StdArrayIO.java
 *  Execution:    java com.cfy.learn.algorithm.util.stdlib.StdArrayIO < input.txt
 ...
 *    1 1 1
 *
 *  % cat tinyDouble1D.txt tinyDouble2D.txt tinyBoolean2D.txt | java com.cfy.learn.algorithm.util.stdlib.StdArrayIO
 *  4
...
public class StdArrayIO {
   ...
   /**
     * Unit tests {@code com.cfy.learn.algorithm.util.stdlib.StdArrayIO}.
     *
