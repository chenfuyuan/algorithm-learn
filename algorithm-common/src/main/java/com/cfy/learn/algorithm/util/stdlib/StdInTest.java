 ...
 * Test client for com.cfy.learn.algorithm.util.stdlib.StdIn and In.
 **/
...
public class StdInTest {
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call com.cfy.learn.algorithm.util.stdlib.StdIn.resync();
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: com.cfy.learn.algorithm.util.stdlib.StdIn.resync is private, only In will be tested.");
